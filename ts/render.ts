...
const renderChord = function(chord: string, instrumentData: InstrumentData): ChordFingeringData[] {
  ...
  var chordFingering = instrumentData.chords[(pitchToFifths.get(m[1])! * 7 + 12000) % 12].get(m[2]);
